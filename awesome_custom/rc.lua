...
-- custom requirements
--local thermal_widget = require("thermal-widget.thermal")
...
--local volumebar_widget = require("volumebar-widget.volumebar-widget")
local volumearc_widget = require("volumearc-widget.volumearc")
...
beautiful.init(HOME .. "/.config/awesome/themes/tick/theme.lua")
...
-- note:
-- never use os.execute: https://awesomewm.org/apidoc/libraries/awful.spawn.html

--    -- Take a screenshot
--    -- sudo apt install scrot
--    -- https://github.com/lcpz/dots/blob/master/bin/screenshot
--    awful.key({ "Mod1" }, "p", function() awful.spawn.with_shell("/usr/bin/screenshot") end,
--              {description = "take a screenshot", group = "hotkeys"}),
--    -- Take a screenshot and open nautilus
--    awful.key({ "Mod1", "Control" }, "p", function() awful.spawn.with_shell("/usr/bin/screenshot && nautilus $HOME/screenshots") end,
--              {description = "take a screenshot and open file manager", group = "hotkeys"}),
    ...
    awful.key({ "Mod1" }, "p", function() awful.spawn.with_shell("deepin-screenshot -s $HOME/screenshots") end,
              {description = "take a screenshot", group = "hotkeys"}),
    -- Take a screenshot and open nautilus
    awful.key({ "Mod1", "Control" }, "p", function() awful.spawn.with_shell("deepin-screenshot -s $HOME/screenshots && nautilus $HOME/screenshots") end,
              {description = "take a screenshot and open file manager", group = "hotkeys"}),
